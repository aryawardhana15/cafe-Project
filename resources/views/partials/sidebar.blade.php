<nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
        <div class="nav">
            @can("is_admin")
            <div class="sb-sidenav-menu-heading text-uppercase">Administrator</div>
            ...
            @else
            <div class="sb-sidenav-menu-heading text-uppercase">Customer</div>
            <a class="nav-link" href="/home">
            ...
            <a class="nav-link" href="/product">
                <div class="sb-nav-link-icon"><i class="fa-solid fa-fw fa-box"></i></div>
                Product
            </a>
