...
document.getElementById("province").addEventListener("change", function() {
    ...
    // Reset dropdown city
    cityDropdown.innerHTML = '<option value="0" selected="selected">Select City</option>'; 
    cityDropdown.disabled = provinceId == 0;
    ...
    // Tambahkan kota ke dalam dropdown jika provinsi valid
    if (cities[provinceId]) {
        cities[provinceId].forEach(city => {
            let option = document.createElement("option");
            option.value = city.id;  // Gunakan ID sebagai value
